...
## Opening the Argo and Minio Dashboards

Wait for services to be ready before accessing dashboards.
...
# EXAMPLE CREDENTIALS - MinIO default dev credentials, not a real secret
# Username: minio
# Password: minio123
```
...
4. Run Ark queries
5. Fan-in and compare results (quality, token count, etc)
...
- [Workflow Templates](/user-guide/workflow-templates) - View workflow templates in the dashboard
- [Resources API](/reference/resources-api) - Access workflow templates via API
