...
If you want deeper Ark integration (automatic agent config resolution, tool definitions, conversation history), see [Building Execution Engines](/developer-guide/building-execution-engines) which uses the Ark Python SDK.
